export const designTokens = {
  ...
  colorAlertSuccessBg: 'rgba(35, 158, 51, 0.16)',
  colorAlertSuccessBorder: 'rgba(35, 158, 51, 0.42)',
  colorAlertSuccessIcon: '#58d26a',
...
const cssVariables: Record<string, string> = {
  ...
  '--color-alert-success-bg': designTokens.colorAlertSuccessBg,
  '--color-alert-success-border': designTokens.colorAlertSuccessBorder,
  '--color-alert-success-icon': designTokens.colorAlertSuccessIcon,
